 ...
 * @n: integer.
 * @prev: points to hte previosu element(s) of the stack (or queue)
...
/**
 * struct instruction_s - opcode and its function(s)
 * @opcode: the opcode
 * @f: function(s) to handle the opcode
 *
 * Description: opcode and its function(s)
...
/**
 * var_t - this contains the file, value and line content
...
void _add(stack_t **atack, unsigned int line_number);
